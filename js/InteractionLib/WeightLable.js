...
export class WeigthLabel {
    constructor(center, weight) {
        ...
        this.html.addEventListener('wheel', (WheelEvent) => { if (this.isHovered) {
            this.weight = this.weight + WheelEvent.deltaY;
        } console.log(this.weight); this.html.textContent = "" + Math.round(100 * this.weight) / 100; });
...
//# sourceMappingURL=WeightLable.js.map